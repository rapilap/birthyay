  ...
  <body>
    ...
    <div v-if="showContent" class="mt-[20rem]">
      <section id="about" class="about">
        <div class="bg-[#F3F2ED] rounded-3xl p-2">
          ...
          <div class="row">
            ...
            <div class="content">
              <h3><u>Dear Sabila Pramesti,</u></h3>
              <p>
                Congratulations! You've been living in this warm world for 22
                years. Alhamdulillah:D
              </p>
              <p>
                Selamat ulang tahun ya bilaappp💖💖💖 Semoga di umur yang
                sekarang ini, kebahagiaan dan keberuntungan selalu datang buat
                babab, aamiin!
              </p>
              <p>*you've grown so much hehe!</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="wishes" class="about">
        ...
        <div class="columns-4 gap-3">
          <div
            class="bg-white break-inside-avoid p-3 rounded-2xl mb-3"
        ...
        <div class="mt-3">
          <div
            class="bg-white break-inside-avoid p-3 rounded-2xl mb-3 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-100 transition"
            @click="goToWishes"
          >
            <!-- ikon plus -->
            <svg
            ...
            <span class="font-semibold text-gray-700">Tambah Pesan</span>
          </div>
        </div>
      </section>
    </div>
